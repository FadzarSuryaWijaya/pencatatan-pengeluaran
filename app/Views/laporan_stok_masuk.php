        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <div class="col-md-6">
                  <label for="reportrangesm">Filter by Date:</label>
                  <div id="reportrangesm" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
...
<script>
    var laporanUrl = '<?php echo site_url('laporan_stok_masuk/read')?>'
    var filterUrl = '<?php echo site_url('laporan_stok_masuk/filter_tanggal')?>' // ke url laporan_stok_masuk/filter_tanggal dari Laporan_stok_masuk::filter_tanggal
</script>
